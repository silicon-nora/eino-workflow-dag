...
(function wrapperForwardBypassSharesEastWithMain() {
  var workItems = wrapper("work_items", 1778, 29, 1328, 451);
  var recommend = wrapper("recommend", 3612, 221, 1051, 68);
  var write = leaf("write", 4028, 463);
  workItems.ports = [
    {
      id: "work_items:east-crit",
      _end: "out",
      _critical: true,
      side: "EAST",
    },
  ...
  var eMain = {
    source: "work_items",
    target: "recommend",
    sourcePort: "work_items:east-crit",
    targetPort: "recommend:west-crit",
    _cyEle: cyEle("critical"),
  };
  var eBypass = {
    source: "work_items",
...
(function claimMainPortOwnersPrefersSameRowThenClosest() {
  ...
  var portrait = leaf("portrait", 0, -80);
...
(function llmFanInBelowUsesSouthWhenWestTaken() {
  ...
  var graph = {
    id: "root",
    _axisProfile: R,
    children: [behavior, summary, portrait, llm],
